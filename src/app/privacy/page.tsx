...
export const metadata: Metadata = {
  title: "Privacy Policy | Spray Foam Receptionist",
  description: "How Spray Foam Receptionist collects and uses information submitted through sprayfoamreceptionist.com.",
};
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-14 space-y-8">
          <p className="text-inkSoft leading-relaxed">
            ...
            &quot;Site&quot;) as an educational resource for spray foam insulation contractors.
            This Privacy Policy explains what information we collect through the Site and how we
            use it.
          </p>
          ...
          <div>
            ...
            <p className="text-inkSoft leading-relaxed mb-3">
              ...
              submit a form on this Site — including the Free Call Coverage Assessment request
              form or the general contact form — we collect the information you enter, which may
              include your name, phone number, company name, and any message or details you
              provide.
            </p>
            <p className="text-inkSoft leading-relaxed">
          ...
          <div>
            ...
            <p className="text-inkSoft leading-relaxed">
              We use the information you submit to respond to your inquiry, schedule and conduct
              a call coverage assessment conversation if requested, and improve the resources on
              this Site. We do not sell your personal information to third parties.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-inkSoft leading-relaxed">
              ...
              necessary to respond to your inquiry and maintain appropriate business records,
          ...
          <div>
            ...
            <p className="text-inkSoft leading-relaxed">
              This Site is intended for business use by contractors and business owners and is
